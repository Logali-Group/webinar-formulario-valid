...
sap.ui.define([
     ...
     */
    function (Controller, Core, MessagePopover, Element, MessageItem, MessageToast, Message, library, JSONModel) {
        "use strict";
        ...
        return Controller.extend("logaligroup.Front.controller.App", {
            ...
            onInit: function () {
                ...
                oModel.loadData("./localService/mockdata/CustomerModel.json", false);
                ...
                this.oMP = new MessagePopover({
                    activeTitlePress: function (oEvent) {
                        var oItem = oEvent.getParameter("item"),
                            oPage = that.getView().byId("employeePage"),
            ...
            _generateInvalidUserInput: function () {
                var oButton = this.getView().byId("messagePopoverBtn"),
                    oRequiredNameInput = this.oView.byId("formContainer").getItems()[0].getContent()[2],
                    oNumericZipInput = this.oView.byId("formContainer").getItems()[0].getContent()[7],
                    oEmailInput = this.oView.byId("formContainer").getItems()[0].getContent()[13],
